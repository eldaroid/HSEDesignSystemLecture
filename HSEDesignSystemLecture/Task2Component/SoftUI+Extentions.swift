...
extension Toggle {
    public func softToggleStyle<S : Shape>(
        _ content: S,
        padding : CGFloat = 16,
        mainColor : Color = Color.white,
        textColor : Color = Color.secondary,
        darkShadowColor: Color = Color.black,
        lightShadowColor: Color = Color.black.opacity(0.3),
    ...
    public func softSwitchToggleStyle(
        tint: Color = .green,
        offTint: Color = Color.secondary,
        mainColor : Color = Color.white,
        darkShadowColor: Color = Color.black,
        lightShadowColor: Color = Color.black.opacity(0.3),
