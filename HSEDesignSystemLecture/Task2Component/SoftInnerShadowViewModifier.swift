...
extension View {
    ...
    public func softInnerShadow<S : Shape>(_ content: S, darkShadow: Color = Color.black, lightShadow: Color = Color.black.opacity(0.2), spread: CGFloat = 0.5, radius: CGFloat = 10) -> some View {
        modifier(
